...
It is the histogram showing the numbers of each classes in the training data, the validation data, and the testing data respectively.
...
Convert the color image to grayscale image and make the data between 0 and 1. The conversion is done for the initial data. It is implemented in `convert_to_grayscale() in Traffic_Sign_Classifier.ipynb Cell [8]`.
